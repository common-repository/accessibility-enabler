...
Contributors: HikeOrders
Tags: accessibility, web accessibility, wordpress accessibility, ada wcag, a11y
...
[Accessibility Enabler](https://hikeorders.com/accessibility/home/) is the accessibility software that helps your visitors to personalize the site based on their needs. On the other hand, it helps you (the website owners) to increase website accessibility compliance. 
...
[Click Here To View Demo](https://accessibility-enabler.myshopify.com/)
...
[View Pricing & Free Trail Details](https://hikeorders.com/accessibility/pricing/?utm_source=wordpress.org&utm_medium=pricing&utm_campaign=wordpress-app-page "Pricing")

== Installation ==

1. Extract `accessibility-enabler.php` to the `/wp-content/plugins/` directory
1. In the admin panel under plugins, activate Accessibility Enabler.
1. Go to Accessibility Enabler Set Up Page Under Settings 
1. Here you need to add the OrgID in the text box given and Save it. Follow the instructions given in the setup page to get OrgID.
1. Were you expecting more steps? Sorry to disappoint!

== Frequently Asked Questions ==

Please Refer To Our [FAQ Here](https://hikeorders.com/accessibility/faq/?utm_source=wordpress.org&utm_medium=faq&utm_campaign=wordpress-app-page "FAQ")

= About =

Accessibility Enabler is developed and maintained by [HikeOrders](https://hikeorders.com/accessibility/home/?utm_source=wordpress.org&utm_medium=about&utm_campaign=wordpress-app-page "hikeorders.com").
For support, contact us at [team@hikeorders.com](mailto://team@hikeorders.com).


== Screenshots ==

1. Accessibility tools
2. Accessibility tools (continued)
3. Accessibility tools (continued)
4. Color themes
5. Accessibility statement

== Changelog ==

= Accessibility Enabler 1.0.0 =
* Initial release!

= Accessibility Enabler 1.5.0 =
* Added new features
* Fixed minor bugs

= Accessibility Enabler 1.6.0 =
* Fixed minor bugs
